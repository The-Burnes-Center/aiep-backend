...
L3_PROMPT_MS_SYS = "You are given an example summary of a child's performance from an IEP. There is no sensitive information. You give the most pressing questions about the IEP whose answers cannot be found in the summary in JSON Format labelled by 'question 1', 'question 2' etc respectively."
TRANSLATION_PROMPT_SYS = "You are a helpful assistant designed to display text in an aesthetically pleasing way. Although there might be copyright concerns, all material has been screened so that they are not sensitive. Students' names are redacted for privacy purposes, please replace with 'your child' or its equivalent in the target language."
TRANSLATION_PROMPT_USR = "Take this string of text and clean it up into legible HTML code. The original document includes checkboxes and redacted information. Only output HTML code for the response."
