...
TRANSLATION_PROMPT_USR = "Take this string of text and clean it up into an HTML file that is legible. This is purely for informational purposes and we have copyright and privacy permissions. Take your time. Must output HTML code."
